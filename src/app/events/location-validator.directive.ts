...
@Directive({
  ...
  providers: [{provide: NG_VALIDATORS, useExisting: LocationValidator, multi: true}] // multi adds the additional validator
})
export class LocationValidator implements Validator {
  validate(formGroup: FormGroup): { [key: string]: any } {
    ...
    if((addressControl && addressControl.value && cityControl && cityControl.value && countryControl && countryControl.value)
      ...
      return {validateLocation : false} //if validation fails
    }
  }
